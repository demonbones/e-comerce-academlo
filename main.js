...
function printProducts(products){
  ...
  for(let i = 0; i < products.length; i++){
    ...
    <div class='product__container'>
      ...
      <div class="product__container__quantity">
...
function modalDetailsElement(product){
  const infoDetails = {
    ...
    name: product.querySelector('.product__container__name p').textContent,
    price: product.querySelector('.product__container__price p').textContent,
    description: product.querySelector('.product__container__description p').textContent,
    quantity :product.querySelector(".product__container__quantity").textContent
  }
  //modalDetails = [...infoDetails]
  addToModal(infoDetails)
}
let modalInjection = "";
 function addToModal(product){
  ...
  <div class="container__all"> 
    ...
    <div class="container_view">
      <div class="container_view_img">
          <img src="${product.image}">
          <div class="container_background"></div>
      </div>
    </div> 
</div>`
modalContent.innerHTML = modalInjection;
}
